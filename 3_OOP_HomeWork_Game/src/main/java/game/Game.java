...
public class Game {
    ...
    public static void init() {
        ...
        System.out.println("Print 1 to start New Game");
    ...
    public static void startGame() {
        ...
        System.out.println("Write help to show info");
    ...
    public static void showHelp() {
        ...
        System.out.println("help - List of all com.ta.java.epam.strings.regex.two.commands");
        ...
        System.out.println("heal - Use all health potion in your inventory");
    ...
    public static void showRoom(Room currentRoom, Room lastRoom, String direction) {
        ...
        if (currentRoom != lastRoom) {
            ...
            if (currentRoom.getChest() != null) {
                ...
                System.out.println("You want to open it ? Check items ? Try 'chest' com.ta.java.epam.strings.regex.two.command ");
            }
    ...
    public static void printAttacks(Room currentRoom) {
        ...
        do {
            ...
            if (input == 1) {
                ...
                System.out.println("Please choose com.ta.java.epam.regex.one option! ");
            }
